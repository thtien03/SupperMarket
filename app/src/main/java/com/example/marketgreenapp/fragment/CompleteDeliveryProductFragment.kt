...
class CompleteDeliveryProductFragment : Fragment() {
    ...
    private var completeDeliveryProductFragment: FragmentCompleteDeliveryProductsBinding? = null
    private val binding get() = completeDeliveryProductFragment!!
    ...
    override fun onCreateView(
        ...
        if (completeDeliveryProductFragment == null)
            completeDeliveryProductFragment =
                FragmentCompleteDeliveryProductsBinding.inflate(layoutInflater)
        completeDeliveryProductFragment!!.lottieLoadingData.visibility = View.VISIBLE
        lifecycleScope.launch(Dispatchers.Main) {
            val currentDataStoreManager = DataStoreManager.getUser()
            if (currentDataStoreManager != null) {
                getDataProductAwaitProcess(currentDataStoreManager)
                completeDeliveryProductFragment!!.lottieLoadingData.cancelAnimation()
                completeDeliveryProductFragment!!.lottieLoadingData.visibility = View.GONE
    ...
    private fun setDataToRecyclerView() {
            ...
            object : ProductAwaitProcessAdapter.IOnClickDeliveryAddress {
                ...
                override fun onClickProductDetail(product: ProductStatus, position: Int) {
                    ...
                    TransitionHelper.navigateWithTransition(
                        ...
                        completeDeliveryProductFragment!!.layoutRoot,
                        "transition_drawer",
                ...
                override fun onClickBuyAgainProduct(product: ProductStatus) {
                    val productBuyAgain = ProductOrder(
                        ...
                        product.productDetail!!.sizeColor.toString()
                    )
                    val totalAmount =
                ...
                override fun onClickEvaluateProduct(product: ProductStatus) {
                    val bundle = Bundle()
                    bundle.putSerializable(ConstantKey.KEY_PRODUCT, product)
                    TransitionHelper.navigateWithTransition(
                        requireActivity(),
                        EvaluateProductActivity::class.java,
                        completeDeliveryProductFragment!!.layoutRoot,
                        "transaction_drawer",
                        R.anim.slide_in_right,
                        R.anim.slide_no_anim,
        ...
        completeDeliveryProductFragment!!.rcvProductCompleteDelivery.setHasFixedSize(false)
        completeDeliveryProductFragment!!.rcvProductCompleteDelivery.layoutManager =
            LinearLayoutManager(requireContext())
        val dividerItemDecoration = DividerItemDecoration(requireContext(), RecyclerView.VERTICAL)
        completeDeliveryProductFragment!!.rcvProductCompleteDelivery.addItemDecoration(
            dividerItemDecoration
        )
        completeDeliveryProductFragment!!.rcvProductCompleteDelivery.adapter =
    ...
    override fun onDestroy() {
        super.onDestroy()
        completeDeliveryProductFragment = null
    }
}